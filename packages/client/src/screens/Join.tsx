...
export function Join({ code, routeKey }: { code: string; routeKey: string | null }) {
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <main
        id="main"
        className="mx-auto flex w-full max-w-xl flex-1 flex-col items-center justify-center gap-6 px-4 py-10"
      >
          ...
          <>
            ...
            */}
            ...
            {error && (
              <p
                role="alert"
                className="rounded-card border-2 border-cherry/40 bg-cherry/10 px-3 py-2 text-sm text-cherry"
              >
                {error}
              </p>
            )}
